...
<div class="container">
    <div class="row mt-3">
        <div class="col-10 mx-auto">
            ...
            <div class="card">
            <h5 class="card-header text-white" style="background-color: #b4918f"><i class="fal fa-prescription-bottle"></i> Gastos Mês a Mês</h5>
            <div class="card-body">
            <form action="index.php?classe=produto&metodo=gravar" method="post">
 
 			<fieldset>
				<a href="index.php"><img src="phplot/relatorios/compra.php" /></a><br><p>
			</fieldset>  
