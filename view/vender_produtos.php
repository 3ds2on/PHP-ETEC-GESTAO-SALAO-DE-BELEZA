...
<head>
    ...
    <title>vender de Produtos</title>
        ...
        <div class="col-10 mx-auto">
            ...
            <div class="card-body">
              <table class="table table-striped table-action" id="tabelaConsulta">
                    <thead>
                        <?php 
						echo "<th class='t-small'>Código</th>";
                        echo "<th class='t-small'>Produto</th>";
                        echo "<th class='t-small'>Preço</th>";
                        echo "<th class='t-small'>Descrição</th>";
                        echo "<th class='t-small'>kit</th>";
                        echo "<th class='t-small'>Categoria</th>";
                        echo "<th class='t-small'>Ação</th>";
						?>
                    </thead>
                    <tbody>
                        <?php 
						...
						?>
                            <tr>
                                ...
                                <td class="t-status t-draft"> 
									<a class="btn btn-success btn-sm" href="index.php?classe=produto&metodo=quantidadeParaVender&codproduto=<?php echo $value->codproduto;?> &nomeproduto=<?php echo $value->nomeproduto;?> &preco=<?php echo $value->preco;?> &descricao=<?php echo $value->descricao;?>  &codcategoria=<?php echo $value->codcategoria;?>"><i class="fas fa-check"></i> Vender</a>
                                </td>
                            </tr>
