...
<div class="container">
    <div class="row mt-3">
        <div class="col-10 mx-auto">
            <div class="card">
            <h5 class="card-header text-white" style="background-color: #b4918f"><i class="fas fa-search"></i> Consulta de Produtos</h5>
            <div class="card-body">
              <table class="table table-striped table-action" id="tabelaConsulta">
                    ...
                    <tbody>
                        ...
                        foreach($dados as $value):
                            if($value->destaque == 1) $value->destaque = "É Kit";
                            else $value->destaque = "Não é Kit";
						...
						?>
                            <tr>
                                ...
                                <td class="t-status t-draft"> 
                                    <a class="btn btn-danger btn-sm" href="index.php?classe=produto&metodo=excluir&codproduto=<?php echo $value->codproduto;?>" onclick="return confirm('DESEJA REALMENTE EXCLUIR?');"><i class="fas fa-trash-alt"></i> Excluir</a>
                                    <a class="btn btn-warning btn-sm" href="index.php?classe=produto&metodo=editar&codproduto=<?php echo $value->codproduto;?> &nomeproduto=<?php echo $value->nomeproduto;?> &preco=<?php echo $value->preco;?> &descricao=<?php echo $value->descricao;?>"><i class="fas fa-edit"></i> Editar</a>
                                </td>
                            </tr>
