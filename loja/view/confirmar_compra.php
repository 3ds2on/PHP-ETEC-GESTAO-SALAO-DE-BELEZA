...
<div class="container">
    <div class="row mt-3">
        <div class="col-10 mx-auto">
            ...
            <div class="card">
            <h5 class="card-header text-white" style="background-color: #b4918f"><i class="fas fa-plus"></i> Comprar produto</h5>
            <div class="card-body"> 
            <form action="controller/comprar.php" method="post">
				...
				<div class="form-group">
                    <label>Quantidade para compra</label>
                    <input type="number" step="any" class="form-control" name="compraQuantidade" id="compraQuantidade" placeholder="Informe a quantidade" required>
                </div>    
